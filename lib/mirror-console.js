...
function MirrorConsole(opts) {
    this.editor = this.createEditor(opts);
}
MirrorConsole.prototype.createEditor = function (opts) {
    var opts = opts || {};
    this.textareaHolder = document.createElement("div");
    this.textarea = document.createElement("textarea");
    this.textareaHolder.appendChild(this.textarea);
    return CodeMirror.fromTextArea(this.textarea, opts);
}
